...
import { HOURS, SITE, LINKS } from "@/lib/content";
      ...
      <div className="mx-auto grid max-w-site items-center gap-12 px-6 lg:grid-cols-2">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-[clamp(40px,6vw,72px)] leading-[1.0]">
            Training in <span className="text-brand-red">Clinton, MA</span>
          </h2>
          <p className="mt-5 max-w-xl text-[17px] leading-relaxed text-muted">
            Our facility is the home base for youth athletic development,
            strength &amp; conditioning, and adult fitness. Stop in to train, or
            take the programming with you on the Learning Platform.
          </p>

          {/* Hours / age-group blocks — PLACEHOLDER details */}
          ...
          <p className="mt-6 text-[13px] text-muted">
            {/* PLACEHOLDER */}
            Address &amp; exact hours: {SITE.contact.address} — client to confirm.
          </p>
